...
sudo ovs-vsctl add-port $sw vxlan1 -- set interface vxlan1 type=vxlan options:key=flow options:dst_port="6633" options:remote_ip=192.168.60.72 options:nsp=flow options:nsi=flow
...
sudo ovs-ofctl add-flow $sw table=0,priority=300,in_port=$eth1_port,nw_src=192.168.50.70,actions=set_nsp:5,set_nsi:255,output:$vxlan1_port
